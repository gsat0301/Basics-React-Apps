package com.gabrieldev.androidmaster.excercise
...
fun printNotificationSummary(numberOfMessages: Int) {
    ...
    if (numberOfMessages >= 100){
        println("¡Tu telefono esta que explota! Tienes +99 notificaciones")

    }else println("Tienes $numberOfMessages notificaciones")
}